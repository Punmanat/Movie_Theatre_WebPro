Vue.component('saturday',{
  ...
  >
    <div
      style="width:100%; height:10%;background: linear-gradient(to right, #99ff66 0%, #ff99cc 100%);"
    >
    ...
    <div style="width:100%; height:40%;background: white;">
      ...
      ">
        <p class="font">Mega Bangna</p>
        <img
        class="ml-2"
          src="https://www.nobitworld.com/wp-content/uploads/2017/12/mega-bangna.png"
          width="100"
          height="100"
          alt=""
        />
